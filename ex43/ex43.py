       ...
       print(dedent("""
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                    ...
                    While hes laughing you run up and shoot him in square in the head putting him down, 
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        while guess != code and guesses < 10:
            print("BZZZZZZZEEEDDD!")
            guesses += 1
            guess = input("[keypad]> ")

        if guess == code:
            print(detent("""What happens if the code is right"""))

            return 'the_bridge'

        else:
            print(detent("""What happens if the code is wrong"""))
